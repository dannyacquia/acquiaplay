...
function bootstrap_sportsratingsacquia_form_system_theme_settings_alter(&$form, &$form_state) {
    ...
    $form['acquiaplay']['welcome']['info1']['info1_title'] = array(
        '#type' => 'textfield',
        '#title' => t('Title'),
        '#default_value' => theme_get_setting('info1_title','bootstrap_sportsratingsacquia'),
    );

    $form['acquiaplay']['welcome']['info1']['info1_content'] = array(
        '#type' => 'textarea',
        '#title' => t('Content'),
        '#default_value' => theme_get_setting('info1_content','bootstrap_sportsratingsacquia'),
    );
    ...
    $form['acquiaplay']['welcome']['info2']['info2_title'] = array(
        '#type' => 'textfield',
        '#title' => t('Title'),
        '#default_value' => theme_get_setting('info2_title','bootstrap_sportsratingsacquia'),
    );

    $form['acquiaplay']['welcome']['info2']['info2_content'] = array(
        '#type' => 'textarea',
        '#title' => t('Content'),
        '#default_value' => theme_get_setting('info2_content','bootstrap_sportsratingsacquia'),
    );
    ...
    $form['acquiaplay']['welcome']['info3']['info3_title'] = array(
        '#type' => 'textfield',
        '#title' => t('Title'),
        '#default_value' => theme_get_setting('info3_title','bootstrap_sportsratingsacquia'),
    );

    $form['acquiaplay']['welcome']['info3']['info3_content'] = array(
        '#type' => 'textarea',
        '#title' => t('Content'),
        '#default_value' => theme_get_setting('info3_content','bootstrap_sportsratingsacquia'),
    );
}
